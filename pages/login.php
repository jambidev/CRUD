...
<html lang="id">
	...
	if(isset($_POST['login'])){
		...
		if($query>0){
			...
			echo '<p>Login dengan username $username berhasil</p>';
			header('location:aplikasi/index.php');
		}else{
			echo '<p>Login dengan username $username Gagal, pastikan username & password tertulis dengan benar</p>';
			header('location:login.php');
		}
	}

	?>
	<body class="" style="background:url('../foto/bg.jpg');background-size:fit;background-repeat: no-repeat; ">
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-transparan animated rollIn">
						<div align="center" class="panel-heading">
							<h3 class=""><b>Login</b></h3>
						</div>
						<div class="panel-body">
							<center><span class="fa fa-user fa-5x fa-white"></span></center>
							<br/>
							<form role="form" action="login.php" method="post">
								<fieldset>
									...
									<div class="form-group float-label">
										...
										<input required class="penuh gede" id="password" placeholder="Password" type="password" name="password"/>
									</div><br/>
							...
							<div class="pesan"></div>
							<center>Belum punya akun? Register <a href="reg.php">disini!</a></center>
						</div>
					</div>
				</div>
			</div>
